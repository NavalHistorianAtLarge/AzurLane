...
async function applyBackgroundFromClass() {
  try {
    ...
    console.log("Background JSON:", bgData);
    ...
    if (!match) {
      console.error("No matching background found for body classes:", classList);
      return;
    }
    ...
    console.error("Error loading background:", err.message);
  }
}
